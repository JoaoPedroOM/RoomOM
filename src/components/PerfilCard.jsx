...
function PerfilCard({img, title, btnTitle, description}) {
  return (
    <>
      <div className="lg:w-[40%] w-[90%] relative mt-4 h-[400px] overflow-hidden group mx-auto dark:bg-black  bg-white dark:border-0 border rounded-md dark:text-white text-black flex flex-col">
        ...
        <article className="p-8 w-full h-full overflow-hidden z-10  absolute top-0 flex flex-col justify-end rounded-md   bg-[#c34c32]  opacity-0 group-hover:opacity-100  transition-all duration-300">
          <div className="translate-y-10 group-hover:translate-y-0 transition-all duration-300 space-y-2">
            ...
            <Link to="https://github.com/JoaoPedroOM" className="p-2 lg:w-1/2 w-[80%] bg-black flex rounded-md text-white">
